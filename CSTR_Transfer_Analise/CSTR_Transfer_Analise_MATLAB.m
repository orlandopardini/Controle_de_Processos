...
%% Nome do modelo
modelName = 'CSTR_Transfer_Analise';
...
% Degraus
add_block('simulink/Sources/Step', [modelName '/F_step'], 'Time', 't_step', 'Before', '0', 'After', num2str(MF))
add_block('simulink/Sources/Step', [modelName '/CA0_step'], 'Time', 't_step', 'Before', '0', 'After', num2str(MCA0))

% Transfer Functions
add_block('simulink/Continuous/Transfer Fcn', [modelName '/G1'], 'Numerator', 'K1', 'Denominator', '[tau 1]')
add_block('simulink/Continuous/Transfer Fcn', [modelName '/G2'], 'Numerator', 'K2', 'Denominator', '[tau 1]')
