...
CArp = 3;    % regime permanente CA
CBrp = 1.1170; % regime permanente CB

% Nome do modelo
modelName = 'VanderVusse_FinalDegrau';
...
% Esperar o Stateflow reconhecer
pause(1)

% Inserir código nas MATLAB Functions
rt = sfroot;
...
% Constantes de referência para regime permanente
add_block('simulink/Commonly Used Blocks/Constant', [modelName '/CArp'], 'Value', '3')
add_block('simulink/Commonly Used Blocks/Constant', [modelName '/CBrp'], 'Value', '1.1170')
...
% Conectar referência regime permanente ao Scope (opcional: plotar no mesmo Scope)
% Se quiser mesmo ver a linha de referência, use um Display ou Scope separado
% Aqui é opcional, pois no Simulink é mais comum plotar depois no MATLAB
